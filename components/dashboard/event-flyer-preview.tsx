...
import type { EventFlyer } from "@/lib/club";
...
export function EventFlyerPreview({
  ...
  return (
    <Dialog>
      <DialogTrigger
        className="group relative mx-auto block w-full max-w-[14.5rem] cursor-zoom-in text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--rotary-gold)] focus-visible:ring-offset-4 focus-visible:ring-offset-[var(--feature-surface)] lg:max-w-none"
