...
import { serviceTotals, type ServiceEntry } from "@/lib/service-record";

export function MemberServiceRecord({entries,isSelf,selectedYear,years}:{entries:ServiceEntry[];today:string;isSelf:boolean;selectedYear:string;years:string[]}) {
