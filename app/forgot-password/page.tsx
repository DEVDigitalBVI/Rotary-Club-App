        ...
        <div className="rise-in rise-in-delay-2 w-full max-w-md">
          <section aria-labelledby="forgot-password-title">
            ...
            <p className="mt-6 text-sm text-muted-foreground">
              <Link
                href="/login"
                className="inline-flex min-h-11 items-center gap-2 rounded-lg pr-3 font-semibold text-primary underline-offset-4 hover:underline focus-visible:ring-2 focus-visible:ring-ring"
              >
